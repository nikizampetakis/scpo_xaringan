...
|                                                                                                            |                                   |
| :--------------------------------------------------------------------------------------------------------- | :-------------------------------- |
| <a href="mailto:florian.oswald@sciencespo.fr">.RUred[<i class="fa fa-paper-plane fa-fw"></i>]               | florian.oswald@sciencespo.fr       |
| <a href="https://github.com/ScPoEcon/ru_xaringan/slides/index.html">.RUred[<i class="fa fa-link fa-fw"></i>] | ScPoEcon/ru_xaringan/slides |
| <a href="http://twitter.com/ScPoEcon">.RUred[<i class="fa fa-twitter fa-fw"></i>]                          | @ScPoEcon                         |
| <a href="http://github.com/ScPoEcon">.RUred[<i class="fa fa-github fa-fw"></i>]                          | @ScPoEcon                       |
